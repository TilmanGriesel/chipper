...
from core.component_factory import PipelineComponentFactory
...
class RAGQueryPipeline:
    ...
    def __init__(self, config: QueryPipelineConfig, streaming_callback=None):
        ...
        # Initialize managers
        self.model_manager = OllamaModelManager(config.ollama_url, config.allow_model_pull)
    ...
    def create_query_pipeline(self) -> Pipeline:
        ...
        try:
            ...
            prompt_builder = self.component_factory.create_prompt_builder(self.QUERY_TEMPLATE)
            query_pipeline.add_component("prompt_builder", prompt_builder)

            ollama_generator = self.component_factory.create_ollama_generator()
